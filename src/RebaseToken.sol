...
//      *
//      */
    function grantMintAndBurnRole( bytes32 _role, address _address) external onlyOwner {
...
//     /// @dev this function increases the total supply.
    function mint(address _to, uint256 _value, uint256 _userInterestRate, bytes32 role) public onlyRole(role) {
...
//     /// @dev this function decreases the total supply.
    function burn(address _from, uint256 _value, bytes32 _role) public onlyRole(_role) {
        // Mints any existing interest that has accrued since the last time the user's balance was updated.
